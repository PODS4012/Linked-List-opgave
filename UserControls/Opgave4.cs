...
using LinkedListsOpgave4;
using System.Text.RegularExpressions;

namespace UserControls
{
    public partial class UCOpgave4 : UserControl
    {
        ...
        private void RefreshListbox()
        {
            ...
            try
            {
                lblFirstNode.Text = $"First Node: {aNode.First.Data.ToString()}";
                lblLastNode.Text = $"Last Node: {aNode.Last.Data.ToString()}";
            }
            catch(NullReferenceException)
            {
                lblFirstNode.Text = $"First Node: Empty";
                lblLastNode.Text = $"Last Node: Empty";
            }
